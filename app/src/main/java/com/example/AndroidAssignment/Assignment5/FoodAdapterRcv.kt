...
import com.example.AndroidAssignment.Assignment4.Bai2.RecycleView.FoodAdapterRecycle
import com.example.kotlinassignment.R

class FoodAdapterRcv (
    private val mlistFood: ArrayList<Food>
//    private var foodListListener: Listener
): RecyclerView.Adapter<FoodAdapterRcv.FoodViewHolder>(){
